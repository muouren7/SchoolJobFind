...
public class Result<T>  implements Serializable {
    ...
    public Result() {
        this.code = Em.SUCCESS.getCode();
        this.msg = Em.SUCCESS.getMsg();
    }
    ...
    public static Result okResult(Object data) {
        Result result = setAppHttpCodeEnum(Em.SUCCESS, Em.SUCCESS.getMsg());
        if(data!=null) {
            result.setData(data);
        }
        return result;
    ...
    public static Result errorResult(Em enums){
        return setAppHttpCodeEnum(enums,enums.getMsg());
    }

    public static Result errorResult(Em enums, String msg){
        return setAppHttpCodeEnum(enums,msg);
    }

    public static Result setAppHttpCodeEnum(Em enums){
        return okResult(enums.getCode(),enums.getMsg());
    }

    private static Result setAppHttpCodeEnum(Em enums, String msg){
